...
public class Dialog_SpitakZinvor_Poxarinum extends android.app.DialogFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        View view=inflater.inflate(R.layout.dialog_spitakzinvor_poxarinum,null);
