...
public class Fragment_dzi extends Fragment {
    ...
    private TextView text_dzi_view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.fragment_dzi,container,false);

        rLayout=view.findViewById(R.id.rLayoutDziFragment);
        ...
        //----------bord------------------------------
        imageBoard=view.findViewById(R.id.bordId_dzi);
        ...
        params_images.setMargins(3*widthLayoutMatrix/8,widthLayoutMatrix/2,0,0);
        ...
        params_images=new RelativeLayout.LayoutParams(widthLayoutMatrix/8,widthLayoutMatrix/8);
        params_images.setMargins(4*widthLayoutMatrix/8,2*widthLayoutMatrix/8,0,0);
        ...
        params_images=new RelativeLayout.LayoutParams(widthLayoutMatrix/8,widthLayoutMatrix/8);
        params_images.setMargins(2*widthLayoutMatrix/8,2*widthLayoutMatrix/8,0,0);
        ...
        params_images=new RelativeLayout.LayoutParams(widthLayoutMatrix/8,widthLayoutMatrix/8);
        params_images.setMargins(widthLayoutMatrix/8,3*widthLayoutMatrix/8,0,0);
        ...
        params_images=new RelativeLayout.LayoutParams(widthLayoutMatrix/8,widthLayoutMatrix/8);
        params_images.setMargins(2*widthLayoutMatrix/8,6*widthLayoutMatrix/8,0,0);
        ...
        params_images=new RelativeLayout.LayoutParams(widthLayoutMatrix/8,widthLayoutMatrix/8);
        params_images.setMargins(4*widthLayoutMatrix/8,6*widthLayoutMatrix/8,0,0);
        ...
        params_images=new RelativeLayout.LayoutParams(widthLayoutMatrix/8,widthLayoutMatrix/8);
        params_images.setMargins(widthLayoutMatrix/8,5*widthLayoutMatrix/8,0,0);
...
//-----------dzi-----------------------------------
        dzi=new ImageView(getContext());
        dzi.setImageResource(R.drawable.dzi_spitak);
        ...
        rLayout.addView(dzi,params_images);
...
//-------------------text--------------------------------
        text_dzi_view=new TextView(getContext());
        text_dzi_view.setText(R.string.text_dzi);
        text_dzi_view.setTextColor(Color.parseColor("#0d0d0d"));
        text_dzi_view.setPadding(0,0,10,0);
        ...
        scrollView.addView(text_dzi_view);
        ...
        animation_type.setImageResource(R.drawable.dzi_spitak);
        params_images=new RelativeLayout.LayoutParams(widthLayoutMatrix/8,widthLayoutMatrix/8);
        ...
        pause_play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (stop_start) {
                    ...
                    stop_start = true;
                    pause_play.setImageResource(R.drawable.pause);
                    a.likeAnimation(dzi,widthLayoutMatrix);
                }
            }
        });
            ...
            AnimatorSet set = new AnimatorSet();
             ...
             if (n==0) {
                ...
                set.setDuration(SHOW_DURATION).playTogether(
                        ...
                        ObjectAnimator.ofFloat(view, View.TRANSLATION_Y, -2*w/8),
                ...
                set.setDuration(SHOW_DURATION).playTogether(
                        ObjectAnimator.ofFloat(view, View.TRANSLATION_X, 2*w/8),
